        ...
        <div id="form-customer-info" class="collapse in">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group col-xs-12 col-sm-6 col-md-6">
                    ...
                    <input id="customer_city" class="form-control" type="text" name="customer_city"
                           placeholder="Madrid">
                </div>
            </div>
        </div>
        <legend role="button" data-toggle="collapse" href="#form-products-list" aria-expanded="false"
                aria-controls="form-products-list">Artículos<span class="pull-right glyphicon glyphicon-chevron-down"></span></legend>
                ...
                <table class="table table-responsive table-bordered" id="products_table">
                    ...
                    <tr class="tr_clone">
                        <td class="product_serial">
                            <select data-width="fit" class="selectpicker" data-live-search="true" id="product_serial"
                                    data-container="body">
                        ...
                        <td class="product_sale_price"><input class="form-control" type="number" step="1" min="0"
                                                              value="<?= $products[0]->sale_price ?>"</td>
                        <td class="product_quantity"><input class="form-control" type="number" value="1" step="1"
